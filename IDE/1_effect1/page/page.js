(function() {
	...
	$('#menu-button-4').onclick = function(){
		...
		$('.see_btn1').onclick = function () {
			if ( this.src.indexOf ('refesh.png') != -1 ) {
				onceClicked = !1;	
				this.src ='1_effect1/images/see_btn.png';
				TweenMax.to ($('.pull_btn') , .5 , {left : -5 });	
				$('.icon1').style.display ='none';
			}else {
				$('.icon1').style.display ='block';
				this.src ='1_effect1/images/refesh.png';
				onceClicked = !0;
		...
		function updateNums (a) {
			...
			$('.number1').src = '1_effect1/images/number'+a.charAt(0)+'.png';
			$('.number2').src = '1_effect1/images/number'+a.charAt(1)+'.png';
			$('.number3').src = '1_effect1/images/number'+a.charAt(2)+'.png';	
		}
		$('.see_btn2').onclick = function () {
			...
			$('.effect_p5_01').src ='1_effect1/images/effect_p5_02.png';
